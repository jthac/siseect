...
public class TesteExperimentoPEETACO {
	...
	private static void runPeetacoDES(String experimento, Classifier regressor1, Classifier regressor2, Classifier regressor3, String avaliacao, TipoMetodoCombinacao metodoDeCombinacao) {
		...
		Utilidade.inicializaListasMetricas();
		new Set_Ensemble_Dynamic(regressor1, regressor2, regressor3).run(new PadraoMiyazaki94(), null, null, null, null, WekaExperiment.KNN3, WekaExperiment.KNN7, WekaExperiment.KNN5,  metodoDeCombinacao, TipoValidacao.LEAVE_ONE_OUT);
		Utilidade.gerarArquivosMassa(0, "SET_ENSEMBLE_DYNAMIC_" + experimento + "_" + metodoDeCombinacao + "_PEETACODES_" + Constantes.QUANTIDADE_CLASSIFICADOR + "CLASSIFICADORES" + avaliacao);
